...
## Credits
- **[Thirteen](https://github.com/Atrix256/Thirteen)**: An awesome minimal & cross-platform graphics interface used for window management & pixel displaying.
- **["Ray Tracing in One Weekend"](https://raytracing.github.io/books/RayTracingInOneWeekend.html)**: An awesome free online book teaching the basics of ray tracing
